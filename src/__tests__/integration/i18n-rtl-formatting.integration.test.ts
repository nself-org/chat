...
describe('i18n + RTL + Formatting Integration', () => {
  ...
  describe('Translation', () => {
    ...
    it('should support translation variables', () => {
      ...
      const translated = template.replace(/{(\w+)}/g, (_, key) => String(variables[key as keyof typeof variables]));
  ...
  describe('Error Handling', () => {
    ...
    it('should handle malformed translation keys', () => {
      ...
      const translated =
        translations['en-US'][key as keyof (typeof translations)['en-US']] || key;
