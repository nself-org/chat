 ...
 */
export function useChannelDraft(channelId: string, options?: Omit<UseDraftOptions, 'contextType' | 'contextId'>) {
  return useDraft({
    contextType: 'channel',
    contextId: channelId,
    ...options,
 ...
 */
export function useThreadDraft(threadId: string, options?: Omit<UseDraftOptions, 'contextType' | 'contextId'>) {
  return useDraft({
    contextType: 'thread',
    contextId: threadId,
    ...options,
 ...
 * Hook for DM draft
 */
export function useDMDraft(conversationId: string, options?: Omit<UseDraftOptions, 'contextType' | 'contextId'>) {
  return useDraft({
    contextType: 'dm',
