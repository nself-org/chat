...
export class ShortcutManager {
  ...
  register(shortcut: RegisteredShortcut): () => void {
    ...
    if (existing) {
      console.warn(`Shortcut ${shortcut.id} already registered, replacing...`);
    }
  ...
  setScopes(scopes: string[]): void {
    this.context.activeScopes = new Set([
  ...
  updateContext(updates: Partial<ShortcutContext>): void {
    this.context = {
      ...
      ...updates,
      activeScopes:
        updates.activeScopes || this.context.activeScopes,
    };
  }
