...
function playNotificationSound(soundUrl: string): void {
  try {
    ...
    console.warn('[Notifications] Failed to create audio:', err);
  }
}
...
function showDesktopNotification(
  ...
  try {
    ...
    console.warn('[Notifications] Failed to show desktop notification:', err);
  }
}
...
export function useNotifications(
  ...
  // Toggle desktop notifications
  const toggleDesktop = useCallback((enabled: boolean) => {
