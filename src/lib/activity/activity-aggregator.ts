 ...
 */
export function flattenAggregatedActivities(items: (Activity | AggregatedActivity)[]): Activity[] {
 ...
 */
export function getAllActivityIds(items: (Activity | AggregatedActivity)[]): string[] {
  const ids: string[] = []
 ...
 */
export function getUnreadCount(items: (Activity | AggregatedActivity)[]): number {
  let count = 0
