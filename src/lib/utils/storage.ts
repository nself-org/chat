  ...
  return {
    ...
    get<K extends keyof T>(
      ...
      try {
        ...
        console.warn(`Error reading from localStorage: ${String(key)}`, error);
        return options.defaultValue;
      }
    },
    ...
    set<K extends keyof T>(
      ...
      try {
        ...
        console.warn(`Error writing to localStorage: ${String(key)}`, error);
        return false;
      }
    },
  ...
  return {
    ...
    get<K extends keyof T>(
      ...
      try {
        ...
        console.warn(`Error reading from sessionStorage: ${String(key)}`, error);
        return options.defaultValue;
      }
    },
    ...
    set<K extends keyof T>(
      ...
      try {
        ...
        console.warn(`Error writing to sessionStorage: ${String(key)}`, error);
        return false;
      }
    },
