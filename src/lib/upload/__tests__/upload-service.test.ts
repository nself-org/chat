...
jest.mock('../file-utils', () => ({
  ...
  generateImageThumbnail: jest.fn(() => Promise.resolve(new Blob(['thumbnail'], { type: 'image/jpeg' }))),
  generateVideoThumbnail: jest.fn(() => Promise.resolve(new Blob(['thumbnail'], { type: 'image/jpeg' }))),
}));
