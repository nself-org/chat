...
export async function openPath(path: string): Promise<string> {
  ...
  // No web fallback
  console.warn('openPath is not available in web environment');
  return '';
}
...
export async function showItemInFolder(path: string): Promise<boolean> {
  ...
  // No web fallback
  console.warn('showItemInFolder is not available in web environment');
  return false;
}
...
export async function showSaveDialog(
  ...
  console.warn('showSaveDialog has limited support in web environment');
