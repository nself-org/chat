  ...
  if (compact) {
    return (
      ...
      >
        ...
        {/* External link icon */}
        <ExternalLinkIcon className="h-3 w-3 flex-shrink-0 text-muted-foreground opacity-0 group-hover:opacity-100 transition-opacity" />
        ...
        {showCloseButton && onClose && (
          <button
            ...
            className="ml-auto flex-shrink-0 rounded-sm p-0.5 hover:bg-muted transition-colors"
...
export function LinkPreviewSkeleton({
  ...
  if (compact) {
    return (
      <div
        className={cn(
          'flex items-center gap-2 rounded-md border border-border/50 bg-muted/30 px-3 py-2',
          className
        )}
      >
  ...
  return (
    <div
      className={cn(
        'flex overflow-hidden rounded-lg border border-border bg-card max-w-lg',
        className
      )}
    >
      <div className="flex flex-1 flex-col p-3">
