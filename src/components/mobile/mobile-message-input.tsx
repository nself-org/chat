          ...
          <div className="flex items-end gap-2 p-2">
            ...
            <div
              className={cn(
                ...
                isFocused && 'bg-muted ring-1 ring-primary/20'
              )}
            >
              <textarea
                ref={textareaRef}
              ...
              {showEmoji && (
                <button
                  ...
                  className="absolute right-2 bottom-2 p-1 text-muted-foreground hover:text-foreground touch-manipulation"
                >
...
const QuickAction = memo(function QuickAction({
  ...
  return (
    <button
      onClick={onClick}
      className="flex flex-col items-center gap-1 p-2 rounded-lg hover:bg-muted touch-manipulation"
    >
