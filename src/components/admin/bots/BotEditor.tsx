...
const AVAILABLE_EVENTS = [
  { id: 'message_created', name: 'Message Created', description: 'Triggered when a message is sent' },
  { id: 'message_edited', name: 'Message Edited', description: 'Triggered when a message is edited' },
  { id: 'message_deleted', name: 'Message Deleted', description: 'Triggered when a message is deleted' },
  { id: 'reaction_added', name: 'Reaction Added', description: 'Triggered when a reaction is added' },
...
const AVAILABLE_PERMISSIONS: { id: BotPermissionScope; name: string; description: string; dangerous?: boolean }[] = [
  ...
  { id: 'messages.delete', name: 'Delete Messages', description: 'Delete bot messages', dangerous: true },
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            {bot ? 'Modify your bot configuration and code' : 'Build a new bot from scratch or use a template'}
          </p>
        </div>
