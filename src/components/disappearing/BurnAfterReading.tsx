...
export function BurnAfterReading({
  ...
  const remainingTime = alreadyStarted && disappearing.expiresAt
  ...
  const startBurnAnimation = useCallback((duration: number) => {
    setIsBurning(true);
        ...
        <AlertDialog open={showConfirm} onOpenChange={setShowConfirm}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                This message will disappear {burnTimer} seconds after you read it.
                Are you ready to view it?
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
          ...
          <div className="flex items-start gap-3">
            <div
              className={cn(
                ...
                isBurning ? 'bg-red-500 text-white animate-pulse' : 'bg-red-500/10 text-red-500'
              )}
            >
              <Flame size={16} />
            </div>
            <div className="flex-1 min-w-0">
              <p className={cn('text-sm', isBurning && 'blur-sm')}>
                {content}
              </p>
            </div>
          </div>
