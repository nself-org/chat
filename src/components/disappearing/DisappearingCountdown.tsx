    ...
    return (
      <div
        className={cn(
          ...
          isWarning && !isUrgent && 'bg-amber-500/10 border-amber-500/20 text-amber-600',
          isUrgent && 'bg-red-500/10 border-red-500/20 text-red-600',
          className
        )}
      >
        {isWarning ? (
    ...
    <div className={cn('flex items-center gap-1.5', className)}>
      ...
      <span
        className={cn(
          ...
          isUrgent && 'text-red-500 font-medium animate-pulse'
        )}
      >
        {formattedTime}
      </span>
