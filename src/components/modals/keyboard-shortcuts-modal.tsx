...
const DEFAULT_SHORTCUTS: Shortcut[] = [
  ...
  { id: 'nav-2', keys: ['Ctrl', 'Shift', 'K'], description: 'Open direct message', category: 'Navigation' },
  { id: 'nav-3', keys: ['Alt', '↑'], description: 'Go to previous channel', category: 'Navigation' },
  { id: 'nav-4', keys: ['Alt', '↓'], description: 'Go to next channel', category: 'Navigation' },
  { id: 'nav-5', keys: ['Alt', 'Shift', '↑'], description: 'Go to previous unread', category: 'Navigation' },
  { id: 'nav-6', keys: ['Alt', 'Shift', '↓'], description: 'Go to next unread', category: 'Navigation' },
  { id: 'nav-7', keys: ['Ctrl', 'Shift', 'T'], description: 'Open threads view', category: 'Navigation' },
  { id: 'nav-8', keys: ['Ctrl', 'Shift', 'A'], description: 'Open activity', category: 'Navigation' },
  { id: 'nav-9', keys: ['Ctrl', 'Shift', 'M'], description: 'Open mentions', category: 'Navigation' },

  // Messages
  { id: 'msg-1', keys: ['Enter'], description: 'Send message', category: 'Messages' },
  { id: 'msg-2', keys: ['Shift', 'Enter'], description: 'New line in message', category: 'Messages' },
  ...
  { id: 'act-4', keys: ['Ctrl', 'Shift', 'F'], description: 'Search everywhere', category: 'Actions' },
  ...
  // Channel
  { id: 'ch-1', keys: ['Ctrl', 'Shift', 'N'], description: 'Create new channel', category: 'Channels' },
  { id: 'ch-2', keys: ['Ctrl', 'Shift', 'I'], description: 'Channel info', category: 'Channels' },
  { id: 'ch-3', keys: ['Ctrl', 'Shift', 'P'], description: 'Toggle pinned messages', category: 'Channels' },
  { id: 'ch-4', keys: ['Ctrl', 'Shift', 'B'], description: 'Toggle bookmarks', category: 'Channels' },
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px] max-h-[80vh] overflow-hidden flex flex-col">
        ...
        <div className="flex items-center justify-between pt-4 border-t text-xs text-muted-foreground">
          <span>Press <KeyBadge keyName="?" /> or <KeyBadge keyName="Ctrl" /> + <KeyBadge keyName="/" /> to open</span>
