      ...
      <CardContent className="space-y-4">
        ...
        <Alert>
          ...
          <AlertDescription>
            ...
            partners can read your messages. Not even the server can decrypt them.
          </AlertDescription>
        </Alert>
        ...
        <Alert>
          <AlertDescription>
            You&apos;ll receive a recovery code after setup. Keep it safe - it&apos;s
            the only way to recover your keys if you forget your password.
          </AlertDescription>
        </Alert>
      </CardContent>
      <CardFooter className="flex justify-between">
