...
export function CommandItem({
  ...
  return (
    ...
    >
      ...
      {/* Keyboard Shortcut */}
      {command.shortcut && (
        <kbd className="hidden sm:inline-flex items-center px-1.5 py-0.5 text-xs font-mono bg-muted text-muted-foreground rounded">
          {command.shortcut}
        </kbd>
      )}
      ...
      {onFavoriteToggle && (
        ...
        >
          {isFavorite ? (
            ...
            <CommandIcons.star className="w-4 h-4" />
          )}
        </button>
      )}
    </div>
