...
const NOTIFICATION_LEVELS: Array<{ value: ChannelNotificationLevel; label: string; description: string }> = [
  ...
  return (
    <div className={cn('space-y-4', className)} {...props}>
      ...
      <div className="flex items-center gap-4 text-sm text-muted-foreground">
        ...
        <span>{Object.values(channelSettings).filter((s) => s.level === 'nothing').length} muted</span>
      </div>
              ...
              <Card key={channel.id} className="p-3">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <Select
                      ...
                      onValueChange={(value) => handleLevelChange(channel.id, value as ChannelNotificationLevel)}
                    >
                ...
                {isExpanded && !muted && (
                  <div className="mt-3 pt-3 border-t">
                    <p className="text-xs text-muted-foreground mb-2">Mute for:</p>
