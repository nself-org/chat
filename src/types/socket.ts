...
export interface ClientToServerEvents {
  ...
  'message:send': (payload: MessageSendPayload, callback: (response: SocketResponse<Message>) => void) => void;
  'message:edit': (payload: MessageEditPayload, callback: (response: SocketResponse<Message>) => void) => void;
  'message:delete': (payload: MessageDeletePayload, callback: (response: SocketResponse<void>) => void) => void;
