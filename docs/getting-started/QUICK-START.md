...
The first time you visit the application, you'll see a **9-step setup wizard**:

1. **Welcome** - Introduction
2. **Owner Info** - Your name, email, company
3. **Branding** - App name, logo, tagline
4. **Theme** - Choose from 25+ presets
5. **Landing Page** - Configure homepage
6. **Auth Methods** - Select authentication providers
7. **Access Permissions** - Set access control
8. **Features** - Enable/disable features
9. **Review** - Review and launch
