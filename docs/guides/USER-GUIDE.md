...
**Version**: 1.0.0
**Welcome to ɳChat** - Modern team communication made simple.
...
7. [Reactions & Threads](#reactions--threads)
...
- **Email Support**: support@nchat.example.com
...
- **Bug Reports**: support@nchat.example.com
- **General Feedback**: feedback@nchat.example.com
