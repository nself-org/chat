...
1. **GitHub Issues:** https://github.com/acamarata/nself-chat/issues
2. **Include:**
   - nself-chat version
   - Operating system
   - Browser version
...
**Still having issues?** Open an issue on [GitHub](https://github.com/acamarata/nself-chat/issues) or ask in [Discussions](https://github.com/acamarata/nself-chat/discussions).
