...
export default function CollectionsPage() {
  ...
  const handleDeleteCollection = (collection: SavedCollection) => {
    if (
      confirm(`Are you sure you want to delete "${collection.name}"? Messages will not be deleted.`)
    ) {
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="border-b">
        <div className="container mx-auto max-w-5xl px-4 py-4">
          <Button variant="ghost" size="sm" className="mb-4" onClick={() => router.push('/saved')}>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Organize your saved messages into collections</p>
            </div>
          </div>
        </div>
      </header>
