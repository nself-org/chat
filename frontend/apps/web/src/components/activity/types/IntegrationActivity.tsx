...
function IntegrationIcon({
  ...
  if (iconUrl) {
    return <img src={iconUrl} alt={type} className={cn('h-5 w-5 rounded', className)} />
  }
...
export function IntegrationActivity({ activity, onClick, className }: IntegrationActivityProps) {
