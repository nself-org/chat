        ...
        <div className="group relative flex items-center">
          ...
          <Link
            ...
            className={cn(
              ...
              isActive && 'bg-zinc-200 font-medium text-zinc-900 dark:bg-zinc-800 dark:text-white'
            )}
        ...
        <div className="space-y-4">
                ...
                <DropdownMenuContent align="end">
                  ...
                  {(user?.role === 'owner' || user?.role === 'admin') && (
                    <>
                      ...
                      <DropdownMenuItem
                        onClick={() =>
                          setShowPublicChannelsAsCategory(!showPublicChannelsAsCategory)
                        }
                      >
          ...
          {!showPublicChannelsAsCategory &&
            (() => {
              ...
              const topLevelChannels = sortChannels(organizedChannels.filter((c) => !c.parentId))
          ...
          {categories
            .filter((cat) => showPublicChannelsAsCategory || cat.id !== 'cat-public')
            .map((category) => {
              ...
              if (parentChannel && !category.hideParentChannel) {
                ...
                topLevelChannels = sortChannels(organizedChannels.filter((c) => !c.parentId))
                renderAsTree = true
              }
              ...
              return (
                <div key={category.id} className="space-y-1">
                  ...
                  {(!category.hideCategory ? !isCollapsed : true) && (
                    <div
                      className={
                        renderAsTree && !category.hideCategory ? 'relative' : 'space-y-0.5'
                      }
                    >
                      ...
                      {topLevelChannels.map((channel, index, array) => (
                        <div
                          key={channel.id}
                          className={renderAsTree && !category.hideCategory ? 'relative' : ''}
                        >
                          ...
                          <div
                            style={{
                              paddingLeft: renderAsTree && !category.hideCategory ? '12px' : '0',
                            }}
                          >
                            {renderChannel(
                              channel,
