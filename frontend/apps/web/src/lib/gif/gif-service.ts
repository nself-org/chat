 ...
 */
export async function proxyGifSearch(params: GifSearchParams): Promise<GifSearchResponse> {
 ...
 */
export async function proxyGifTrending(params?: GifTrendingParams): Promise<GifTrendingResponse> {
  const response = await fetch('/api/gif', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
