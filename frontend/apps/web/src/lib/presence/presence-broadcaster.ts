...
export class PresenceBroadcaster {
   ...
   */
  broadcastPresence(status: PresenceStatus, customStatus?: CustomStatus, force = false): boolean {
  ...
  private handleTypingStop(event: { userId: string; channelId: string; threadId?: string }): void {
