 ...
 */
export function filterSavedMessages(saved: SavedMessage[], filters: SavedFilters): SavedMessage[] {
 ...
 */
export function getSavedMessages(saved: SavedMessage[], options: SavedListOptions): SavedMessage[] {
  let result = [...saved]
  ...
  // Sort
  result = sortSavedMessages(result, options.sortBy ?? 'savedAt', options.sortOrder ?? 'desc')
